  ...
  Map<String, String> initWords(String language) {
    return language == 'En'
        ? {
            ...
            'LoginPageAnonymousDialogTitle': 'Anonymous Login',
            'LoginPageAnonymousDialogDropDown': 'Choose Your Nationality',
            'LoginPageAnonymousDialogOkButton': 'Login',
        ...
        : {
            ...
            'LoginPageAnonymousDialogTitle': 'الدخول بدون تسجيل',
            'LoginPageAnonymousDialogDropDown': 'أختر جنسيتك',
            'LoginPageAnonymousDialogOkButton': 'تسجيل الدخول',
